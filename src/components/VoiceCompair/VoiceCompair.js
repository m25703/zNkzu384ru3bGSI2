...
import AudioRecorderHindi from '../AudioRecorderTamil/AudioRecorderTamil';
...
const VoiceCompair = props => {
  ...
  //for Hindi language
  const [HindiRecordedAudio, setHindiRecordedAudio] = useState('');
  const [HindiRecordedText, setHindiRecordedText] = useState('');

  useEffect(() => {
    props.setVoiceText(HindiRecordedText);
    props.setRecordedAudio(HindiRecordedAudio);
  }, [HindiRecordedText]);
            ...
            if (audioPermission) {
              return (
                <>
                  {lang_code == 'hi' ? (
                    <AudioRecorderHindi
                      setHindiRecordedAudio={setHindiRecordedAudio}
                      setHindiRecordedText={setHindiRecordedText}
                      flag={props.flag}
                    />
                  ) : (
